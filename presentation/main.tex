...
\begin{frame}{Research Question}{Importance and Relevance}
    \begin{block}{Does elite performance matters in education and human capital?}
        \begin{itemize}
            ...
            \item Elite students and top university research may give countries a technology advantage
        \end{itemize}
    \end{block}

    \begin{block}{Implications for economic convergence}
        \begin{itemize}
            \item Richer, larger countries will likely have better research output and universities
            \item Technology and trade conflict between China-US have shown that ``hoarding'' technology may widen gap between nations
        \end{itemize}
...
\begin{frame}{PISA panel regression}{Without imputation}
    \begin{table}[!htbp] \centering
        \resizebox{\linewidth}{!} {
            \begin{tabular}{@{\extracolsep{5pt}}lcccc}
                \\[-1.8ex]\hline
